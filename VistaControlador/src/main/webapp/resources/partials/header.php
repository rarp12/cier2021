<?php 
// You can easily build the menu with php predefined function written by me (@bootstrapguru). It is located in root folder with file name called menu-builder.html
