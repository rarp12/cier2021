 ...
 * @author rarp1
 */
public class LazySorterGeneralidades implements Comparator<GeneralidadesBean.Registro> {
     ...
     * @param sortOrder
     */  
    public LazySorterGeneralidades(String sortField, SortOrder sortOrder) {
     ...
     */
    @Override
    public int compare(GeneralidadesBean.Registro object1, GeneralidadesBean.Registro object2) {
        try {
