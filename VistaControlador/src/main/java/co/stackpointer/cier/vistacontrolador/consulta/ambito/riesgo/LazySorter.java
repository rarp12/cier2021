 ...
 * @author rarp1
 */
public class LazySorter  implements Comparator<RiesgosNaturalesBean.Registro> {
     ...
     */
    @Override
    public int compare(RiesgosNaturalesBean.Registro object1, RiesgosNaturalesBean.Registro object2) {
        try {
