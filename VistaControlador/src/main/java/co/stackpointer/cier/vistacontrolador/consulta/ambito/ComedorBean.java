 ...
 * @author user
 */
@ManagedBean(name = "comedor")
@ViewScoped
public class ComedorBean extends ConsultaAmbito {
    ...
    final String columnaNumEspaciosPorTipo = Utilidades.obtenerMensaje("consultas.ambito.comedor.column.numEspacios");
    final String columnaProporcionEspacios = Utilidades.obtenerMensaje("consultas.ambito.comedor.column.propEspacios");
    final String columnaPoblacionAtendida = Utilidades.obtenerMensaje("consultas.ambito.comedor.column.pobAtendida");
    final String columnaNumSedesIncumplen = Utilidades.obtenerMensaje("consultas.ambito.comedor.column.numSedIncumplen");
    final String columnaAreaIdonea = Utilidades.obtenerMensaje("consultas.ambito.comedor.column.areaIdonea");
    final String columnaDeficitEstandar = Utilidades.obtenerMensaje("consultas.ambito.comedor.column.deficit");
    final String columnaProporcionSedesIncumplen = Utilidades.obtenerMensaje("consultas.ambito.comedor.column.propSedIncumplen");
    final String columnaAreaEspacio = Utilidades.obtenerMensaje("consultas.ambito.comedor.column.areaEspacios");
    final String columnaCumplimientoNorma = Utilidades.obtenerMensaje("consultas.ambito.comedor.column.cumpNorma");
    ...
    public void consultar() {
        ...
        filtro.setUnidadFuncional("COMEDOR");

        List<Object[]> resultados = facAmbito.consultarComedor(filtro);
