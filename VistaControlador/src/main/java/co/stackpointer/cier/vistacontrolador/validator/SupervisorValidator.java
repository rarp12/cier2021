 ...
 * @author stackpointer
 */
@ManagedBean(name = "supervisorValidator")
@ViewScoped
public class SupervisorValidator implements Validator, Serializable {

    @EJB
    EncuestadorSupervisorFacadeLocal fachadaSupervisor;
    ...
    public void validate(FacesContext context, UIComponent component,
        ...
        if (value != null) {
            ...
            if (!matcher.matches()) {
                ...
                if (fachadaSupervisor.existeSupervisor(identificacion)) {
        ...
        if (value != null) {
            ...
            if (!matcher.matches()) {
                ...
                if (!identificacionActual.equalsIgnoreCase(identificacion)) {
                    if (fachadaSupervisor.existeEncuestador(identificacion)) {
                        FacesMessage msg = Messages.createError(identificacion + " ya existe.");
                        throw new ValidatorException(msg);
                    }
                }
